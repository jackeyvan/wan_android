...
import 'banner_model.dart' as _i4;
import 'package:wan_android_shared/src/api_response.dart' as _i5;
...
class Protocol extends _i1.SerializationManagerServer {
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'banner_model_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'isVisible',
          columnType: _i2.ColumnType.bigint,
  ...
  T deserialize<T>(
    ...
    if (t == _i4.BannerModel) {
      return _i4.BannerModel.fromJson(data) as T;
    }
    if (t == _i1.getType<_i3.ArticleModel?>()) {
      return (data != null ? _i3.ArticleModel.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i4.BannerModel?>()) {
      return (data != null ? _i4.BannerModel.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'BannerModel') {
      return deserialize<_i4.BannerModel>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i4.BannerModel:
        return _i4.BannerModel.t;
    }
    return null;
  }
